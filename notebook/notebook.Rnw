...
\item Quantifying Heritability 
\item Network and Co-occurrence Modeling
\end{enumerate}

\section{Compositional Analyses}
\begin{itemize}
\item PerMANOVA (including dispersion tests)
%%Vegan - adonis
\item NMDS (include test using scores)
%%Ecodist - nmds
\item Cross-hair plots
%%Internal/Vegan
\end{itemize}
...
\begin{itemize}
\item Shuster's calculator
%%Internal - h2c
\item Community Simulator from Shuster 2006
%%Internal - cgSim
\end{itemize}
...
\begin{itemize}
\item Araujo's Method
%%internal - coNet
\item Co-ocurrence using appropriate null model
%%vegan/internal - nullSim
\end{itemize}

\subsection*{Network/Co-occurrence Analysis Outline}
\begin{enumerate}
%%internal - cgNet
%%stand level option
